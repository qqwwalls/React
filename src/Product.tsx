...
function Product({ product }: { product: ProductType }) {
    ...
    return (
        <div ref={productRef} className="w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto bg-white border border-gray-200 rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col group">
